...
def learn(outfile,statsfile,genemap,G,pos,negs,epsilon,timesteps,iterative_update,verbose,force,write=False):
    if not force and os.path.isfile(outfile):
        ...
        if write:
            fileIO.writeResults(statsfile,outfile,times,changes,predictions,genemap)
